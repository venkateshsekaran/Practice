...
const Dashboard = () => {
    ...
    const [clientDetails, clientDetailsUpdate] = useState(localStorage.getItem('clientId'))
    ...
    return (
        <AdminLayout>
            <h3 className="text-center mb-2"> Client Dashboard </h3>
            <Form onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <Col sm={3}>
                            <Form.Control className="clientTableFormControl"
                                ...
                                <option value={''}>Building no</option>
                                {
                                    singleClient.addresses.length > 0 &&
                                    singleClient.addresses.map((addressItem, index) => {
                                        return <option key={index} value={addressItem.buildingNo}>{addressItem.buildingNo} </option>
                                    })
                            ...
                            <Form.Control className="clientTableFormControl" placeholder="floors"
                                ...
                                <option value={''}>Floors</option>
                                {
                                    floorsList.length > 0 && floorsList.map((floorItem, index) => {
                                        ...
                                        return <option key={index} value={`${floorItem.floorNo}*${floorItem.type}`}> {floorItem.floorNo}  </option>
                                    })
                                }
                            </Form.Control>
                        </Col>
                 ...
                 */}
                                ...
                                controllerIdSelected && <div><label>Controller switch</label> <Switch onChange={() => {
