...
const ClientTable = () => {
        ...
        [{
            id: Math.random(), buildingNo: "", address: "", floors: [{
                id: Math.random(), floorNo: '',  ahu: [
                    {
                        id: Math.random(), UVHealSystemType: '', name: '', AHUNumber: '', CFM: '',
                        heightOfCoil: '', widthOfCoil: '', AHUMake: '', starterPanel: '',
                        limitSwitch: '', UVhealCoilModel: '', controllerId: '',
                         isConfirm: false,isCoilConfirm:false
                        , duct: [{
                            id: Math.random(), ductId: '', ductHeight: '',
                            ductWidth: '', ductLength: '', ductMaterial: '', CFM: '',
                            UVhealDuctModel: '', controllerId: '', isDuctConfirm: false
                        }]
                    }
                ]
            }]
    ...
    const generateControllerId = (i1, i2) => {
        const { buildingNo } = i1
        let { floorNo } = i2
        if (floorNo < 10) {
            floorNo = '0' + floorNo
        ...
        try {
            ...
            return `${clientId.substring(0, 2)}${clientName.substring(0, 2)}${buildingNo.substring(0, 2)}${floorNo.substring(0, 2)}${random}`
        } catch (error) {
            console.log(error);
        }
    }
                                        ...
                                        return (
                                            <div className="addressCard" key={index}>
                                                <Row>
                                                    ...
                                                    <Col sm={4}>
                                                        <Form.Control disabled={item?.isFloorConfirm}
                                                         required className="clientTableFormControl" type="text" placeholder="Floor"
                                                            value={item?.floorNo}
                                                            onChange={(e) => {
                                                                addressesUpdate(addresses?.map((i) => {
                                                                    if (i?.id == addressItems?.id) {
                                                        ...
                                                        (<>
                                                            {
                                                                item?.ahu?.map((ahu, index) => {
                                                                    return (<>
                                                                        ...
                                                                        <Row>
                                                                            <Col sm={4}>    <Form.Control disabled={ahu?.isConfirm} className="clientTableFormControl" type="text" placeholder="Name" name="name" value={ahu?.name} onChange={(e) => { handleChange(e, addressItems, item, ahu) }} />   </Col>
                                                                            <Col sm={4}>     <Form.Control disabled={ahu?.isConfirm} className="clientTableFormControl" type="text" placeholder="AHU Number" name="AHUNumber" value={ahu?.AHUNumber} onChange={(e) => { handleChange(e, addressItems, item, ahu) }} /> </Col>
                                                                            <Col sm={4}>    <Form.Control disabled={ahu?.isConfirm} className="clientTableFormControl" type="text" placeholder="AHU Model" name="ahuModel" value={ahu?.ahuModel} onChange={(e) => { handleChange(e, addressItems, item, ahu) }} />   </Col>
                                                                            <Col sm={4}>     <Form.Control disabled={ahu?.isConfirm} className="clientTableFormControl" type="number" placeholder="CFM" name="CFM" value={ahu?.CFM} onChange={(e) => { handleChange(e, addressItems, item, ahu) }} /> </Col>

                                                                            <Col sm={4}>    <Form.Control disabled={ahu?.isConfirm} className="clientTableFormControl" type="text" placeholder="AHU Make" name="AHUMake" value={ahu?.AHUMake} onChange={(e) => { handleChange(e, addressItems, item, ahu) }} /> </Col >
                                                                            <Col sm={4}>    <Form.Control disabled={ahu?.isConfirm}
                                                                                className="clientTableFormControl"
                                                                                type="text"
                                                                                placeholder="Starter Panel Type"
                                                                                name="starterPanel"
                                                                                value={ahu?.starterPanel}
                                                                                onChange={(e) => { handleChange(e, addressItems, item, ahu) }} as="select" custom >
                                                                                ...
                                                                                <Row className="mb-2">
                                                                                    ...
                                                                                    <Col>
                                                                                        <div   onChange={(e) => { handleChange(e, addressItems, item, ahu) }}>
                                                                                            <input  disabled={ahu?.isConfirm} type="radio" value="yes" name="limitSwitch" /> Yes {' '}
                                                                                            <input disabled={ahu?.isConfirm} type="radio" value="no" name="limitSwitch" /> No {' '}
                                                                                        </div>
                                                                                    </Col>
                                                                                </Row>
                                                                            </Col>
                                                                                ...
                                                                                <Row className="mb-2">
                                                                                    ...
                                                                                    <Col>
                                                                                        <div className="mb-2"  onChange={(e) => { handleChange(e, addressItems, item, ahu) }}>
                                                                                            <input disabled={ahu?.isConfirm} type="radio" value="coil" name="UVHealSystemType" /> Coil {' '}
                                                                                            <input disabled={ahu?.isConfirm} type="radio" value="duct" name="UVHealSystemType" /> Duct {' '}
                                                                                            <input disabled={ahu?.isConfirm} type="radio" value="both" name="UVHealSystemType" /> Both {' '}
                                                                                        </div>
                                                                                    </Col>
                                                                                </Row>
                                                                                {
                                                                                            ahu?.isConfirm ?
                                                                                                <Button size="sm" onClick={() => {
                                                                                                    const e = {}
                                                                                                    e.target = { name: 'isConfirm', value: false }
                                                                                                    handleChange(e, addressItems, item, ahu)
                                                                                                }}> Edit  </Button>
                                                                                                :
                                                                                                <Button size="sm" onClick={() => {
                                                                                                    const e = {}
                                                                                                    e.target = { name: 'isConfirm', value: true }
                                                                                                    handleChange(e, addressItems, item, ahu)
                                                                                                }}> Confirm  </Button>
                                                                                        }
                                                                                {
                                                                                    (ahu?.UVHealSystemType == 'coil' || ahu?.UVHealSystemType == 'both') &&
                                                                                    <p className="clientTableHead mt-3"> Coil Details :
...

                                                                            {
                                                                                (ahu?.UVHealSystemType == 'coil' || ahu?.UVHealSystemType == 'both') && <>
                                                                                    <Col sm={4}>
                                                                                        ...
                                                                                        <Button disabled={ahu?.isCoilConfirm} 
                                                                                            onClick={() => { setShowCoil(true) }} className="inputBtn" >
                                                                                    ...
                                                                                    <Col sm={4}>
                                                                                        <Button disabled={ahu?.isCoilConfirm} 
                                                                                            onClick={() => {
                                                                                                setShowControllerIdDuct(true)
                                                                                                handleBtnChange('controllerId', generateControllerId(addressItems, item), addressItems, item, ahu)
                                                                                            }} className="primary inputBtn borderBlue" >
                                                                                            {ahu?.controllerId ? `Controller Id : ${ahu?.controllerId}` : 'MANAGE CONTROLLER'} </Button>
                                                                                        ...
                                                                                        <Modal size="lg"
                                                                                            show={showControllerIdDuct}
                                                                                            onHide={() => { setShowControllerIdDuct(false) }}>
                                                                                            <Modal.Header closeButton>
                                                                                            </Modal.Header>
                                                                                            <ControllerTable
                                                                                            setShowControllerId={setShowControllerId} 
                                                                                            setShowControllerIdDuct={setShowControllerIdDuct}
                                                                                             id={ahu?.controllerId} isDisabled={true}
                                                                                             handlePropChange={(e)=>{
                                                                                                handleBtnChange('controllerId', e.target.value, addressItems, item, ahu)
                                                                                             }} />
                                                                                        </Modal>
                                                                                        ...
                                                                                        <Modal show={false}
                                                                                            onHide={() => { setShowControllerIdDuct(false) }} >
                                                                                            <Modal.Header closeButton>
                                                                                                <Modal.Title> Controller Id : 
                                                                                                    <span className="borderWhite"> {ahu?.controllerId} </span></Modal.Title>
                                                                                            </Modal.Header>
                                                                                            <Modal.Body>
                                                                                                <Form.Control className="clientTableFormControl" type="text"
                                                                                                    placeholder="Search"
                                                                                    ...
                                                                                    <Col sm={4}>    <Form.Control disabled={ahu?.isCoilConfirm} className="clientTableFormControl" type="text" placeholder="Height of Coil" name="heightOfCoil" value={ahu?.heightOfCoil} onChange={(e) => { handleChange(e, addressItems, item, ahu) }} /> </Col>
                                                                                    <Col sm={4}>    <Form.Control disabled={ahu?.isCoilConfirm} className="clientTableFormControl" type="text" placeholder="Width of Coil" name="widthOfCoil" value={ahu?.widthOfCoil} onChange={(e) => { handleChange(e, addressItems, item, ahu) }} /> </Col>
                                                                                    <Col sm={12}> 
                                                                                    {
                                                                                                    ahu?.isCoilConfirm ?
                                                                                                        <Button size="sm" onClick={() => {
                                                                                                            const e = {}
                                                                                                            e.target = { name: 'isCoilConfirm', value: false }
                                                                                                            handleChange(e, addressItems, item, ahu)
                                                                                                        }}> Edit  </Button>
                                                                                                        :
                                                                                                        <Button size="sm" onClick={() => {
                                                                                                            const e = {}
                                                                                                            e.target = { name: 'isCoilConfirm', value: true }
                                                                                                            handleChange(e, addressItems, item, ahu)
                                                                                                        }}> Confirm  </Button>
                                                                                                }
                                                                                                </Col>
                                                                            ...
                                                                            <div className="mx-3">
                                                                                {(ahu?.UVHealSystemType == 'duct' || ahu?.UVHealSystemType == 'both') &&
                                                                                    ahu?.duct?.map((duct) => {
                                                                                        return (<>
                                                                                            <p key={duct} className="clientTableHead text-center"> Duct Details :
                                                                                         
                                                                                            </p>
                                                                                            <Row>
                                                                                                <Col sm={4}>
                                                                                                    <Button disabled={duct?.isDuctConfirm} onClick={() => { setShowDuct(true) }} type="button"
                                                                                                ...
                                                                                                <Col sm={4}>
                                                                                                    <Button disabled={duct?.isDuctConfirm} onClick={() => {
                                                                                                        setShowControllerId(true)
                                                                                                        handleBtnChangeDuct('controllerId', generateControllerId(addressItems, item), addressItems, item, ahu, duct)
                                                                                                    }} className="primary inputBtn borderBlue" >
                                                                                                        {duct?.controllerId ? `Controller Id : ${duct?.controllerId}` : 'MANAGE CONTROLLER'}
                                                                                                    </Button>
                                                                                                    ...
                                                                                                    <Modal size="lg"
                                                                                                        ...
                                                                                                        setShowControllerIdDuct={setShowControllerIdDuct}
                                                                                                         setShowControllerId={setShowControllerId} 
                                                                                                        id={duct?.controllerId} 
                                                                                                        isDisabled={true}
                                                                                                        handlePropChange={(e)=>{
                                                                                                        handleBtnChangeDuct('controllerId', e.target.value, addressItems, item, ahu, duct)
                                                                                                         }} />
                                                                                                    </Modal>
                                                                                                ...
                                                                                                <Col sm={4}>    <Form.Control disabled={duct?.isDuctConfirm} className="clientTableFormControl" type="text" placeholder="Duct Id" name="ductId" value={duct?.ductId}
                                                                                                    onChange={(e) => { handleDuctChange(e, addressItems, item, ahu, duct) }} />   </Col>
                                                                                                <Col sm={4}>     <Form.Control disabled={duct?.isDuctConfirm} className="clientTableFormControl" type="text" placeholder="Duct Height" name="ductHeight" value={duct?.ductHeight} onChange={(e) => { handleDuctChange(e, addressItems, item, ahu, duct) }} /> </Col>
                                                                                                <Col sm={4}>     <Form.Control disabled={duct?.isDuctConfirm} className="clientTableFormControl" type="text" placeholder="Duct Width" name="ductWidth" value={duct?.ductWidth} onChange={(e) => { handleDuctChange(e, addressItems, item, ahu, duct) }} /> </Col>
                                                                                                {/* <Col sm={4}>    <Form.Control disabled={duct?.isDuctConfirm} className="clientTableFormControl" type="text" placeholder="Duct Length" name="ductLength" value={duct?.ductLength} onChange={(e) => { handleDuctChange(e, addressItems, item, ahu, duct) }} /> </Col> */}
                                                                                                <Col sm={4}>    <Form.Control disabled={duct?.isDuctConfirm} className="clientTableFormControl" type="number" placeholder="CFM" name="CFM" value={duct?.CFM} onChange={(e) => { handleDuctChange(e, addressItems, item, ahu, duct) }} /> </Col >
                                                                                               <Col sm={12}>
                                                                                                {
                                                                                                    duct?.isDuctConfirm ?
                                                                                                        <Button size="sm" onClick={() => {
                                                                                                            const e = {}
                                                                                                            e.target = { name: 'isDuctConfirm', value: false }
                                                                                                            handleDuctChange(e, addressItems, item, ahu ,duct)
                                                                                                        }}> Edit  </Button>
                                                                                                        :
                                                                                                        <Button size="sm" onClick={() => {
                                                                                                            const e = {}
                                                                                                            e.target = { name: 'isDuctConfirm', value: true }
                                                                                                            handleDuctChange(e, addressItems, item, ahu ,duct)
                                                                                                        }}> Confirm  </Button>
                                                                                                }
                                                                                                </Col>
                                                                                                    ...
                                                                                                    if (floor?.id == item?.id) {
                                                                                                        ...
                                                                                                        const newAhu = floor?.ahu.map((ahuItem) => {
                                                                                                            if (ahuItem.id == ahu.id) {
                                                                                                                ...
                                                                                                                const obj = { id: Math.random(), ductId: '', isDuctConfirm: false, ductHeight: '', ductWidth: '', ductLength: '', ductMaterial: '', CFM: '', UVhealDuctModel: '', controllerId: '' }
                                                                            ...
                                                                            if (i?.id == addressItems?.id) {
                                                                                const floorsArr = i?.floors?.map((floor) => {
                                                                                    if (floor?.id == item?.id) {
                                                                                        ...
                                                                                        const obj = {
                                                                                            id: Math.random(), duct: [{ id: Math.random(), ductId: '', ductHeight: '', ductWidth: '', ductLength: '', ductMaterial: '', CFM: '', UVhealDuctModel: '', controllerId: '', isConfirm: false }]
                                                                                            , UVHealSystemType: '', name: '', AHUNumber: '', CFM: '', heightOfCoil: '', widthOfCoil: '', AHUMake: '', starterPanel: '', limitSwitch: '', UVhealCoilModel: '', controllerId: '', isDuctConfirm: false
                                                                                        }
